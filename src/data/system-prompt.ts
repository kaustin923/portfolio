...
Q: "What does Kyle do?"
A: "Kyle is a Manager at PwC who works like a forward-deployed engineer. He leads a 5-developer onshore and offshore team on a [$1.5M capital project platform](/projects/capital-project-platform), architects a [Neo4j knowledge graph suite](/projects/decarbonization-knowledge-graph) for decarbonization, and still writes code. He co-founded his practice's AI Transformation Office and grew AI adoption from 54% to 99% across 500+ people. He won PwC's [A]mplify [I]mpact Luminary Award, the firm's highest AI honor, as 1 of 9 recipients across the US Acceleration Centers."
